...
check('swap_execute_requires_confirmation', c == 409 and r['error'] == 'settlement_confirmation_required')
r, c = M.swap_execute({'offer_id': oid, 'agent_id': 'ktd-orchestrator', 'settlement_tx': 'a' * 64, 'confirmations': 1})
check('swap_execute', c == 200 and r['settled'] and r['out_bait'] > 0 and r['confirmations'] == 1)
r = M.swap_book()
